-- WELCOME P0 schema contract starter. Not a drop-in Supabase migration.
-- Application/RLS policies and encryption are implementation-specific and MUST be tested.
