      ...
      <div className="mt-6">
        <DirectoryPanel
          ...
          strings={{
            ...
            revealChooserTitle: (name) => t('directory.revealChooserTitle', { name }),
            ...
            score: (n) => t('directory.score', { score: n }),
            reasonsForMe: (reasons) => t('directory.reasonsForMe', { reasons }),
            reasonsForThem: (reasons) => t('directory.reasonsForThem', { reasons }),
