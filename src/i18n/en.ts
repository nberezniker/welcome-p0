...
export const en = {
  ...
  'intros.calendar.title': 'Add to my calendar',
  'intros.calendar.hint': 'One event in your own Google Calendar. Their address is not sent to Google.',
  'intros.calendar.startLabel': 'Starts',
  'intros.calendar.endLabel': 'Ends (optional)',
  'intros.calendar.timezoneLabel': 'Your timezone',
  'intros.calendar.submit': 'Add to Google Calendar',
  'intros.calendar.sending': 'Adding…',
  'intros.calendar.done': 'Added to your calendar.',
  'intros.calendar.openInGoogle': 'Open in Google Calendar',
  'intros.calendar.addressNotSent': 'Their address was not sent to Google.',
  'intros.calendar.connectLink': 'Open integrations',
  'intros.calendar.notConfigured': 'This instance has no Google OAuth client: {env} is missing, so no meeting can be added to Google Calendar here.',
  'intros.calendar.notConnected': 'Google Calendar is not connected for your account yet. Connect it once and this form will add the meeting.',
  'intros.calendar.reconnect': 'The Google connection must be renewed before a meeting can be added.',
  'intros.calendar.error.not_connected': 'Google Calendar is not connected for your account, so nothing was added.',
  'intros.calendar.error.reconnect_required': 'The Google connection must be renewed before a meeting can be added.',
  'intros.calendar.error.scope_missing': 'Google refused the calendar permission for this account.',
  'intros.calendar.error.rate_limited': 'Google is rate limiting this connection. Try again in a minute — nothing was added.',
  'intros.calendar.error.google_unavailable': 'Google is not answering right now. Nothing was added.',
  'intros.calendar.error.counterpart_not_found': 'That person’s card is no longer available, so no meeting was created.',
  'intros.calendar.error.invalid_time': 'Check the start and end time.',
  'intros.calendar.error.invalid_timezone': 'Your device did not report a usable timezone, so the meeting cannot be placed on your calendar.',
  'intros.calendar.error.other': 'The meeting could not be added. Nothing was changed on your calendar.',
  ...
  'event.calendarMore': 'More options',
